...
exports.Internal.prototype.message = 'Internal Error';

exports.BadRequest = function (msg) {
    HttpError.call(this, msg, 400, this.constructor);
};
util.inherits(exports.BadRequest, HttpError);

exports.BadRequest.prototype.message = 'Bad Request Error';